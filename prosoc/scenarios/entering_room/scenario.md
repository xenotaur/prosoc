...
evaluation_notes: >
  ...
  Related Scenarios note: P&G Table 3 lists "Entering Elevator (R@G)" as
  this scenario's related entry, which has no implemented scenario
  directory under prosoc/scenarios/. `related_scenarios` instead
  references exiting_room and narrow_doorway, which this card's own Notes

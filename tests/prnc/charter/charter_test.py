...
import prosoc
from prosoc.prnc.charter import distill, loader
...
class TestCharterFilesWellFormed(unittest.TestCase):
    ...
    def setUp(self):
        # Locate prosoc/prnc/charter directory via package import
        charter_dir = Path(prosoc.__file__).parent / "prnc" / "charter"
    ...
    def test_charter_md_exists(self):
        self.assertTrue(
            ...
            "charter.md must exist in prosoc/prnc/charter",
        )

    def test_charter_yml_exists(self):
        self.assertTrue(
            self.charter_yml.exists(),
            "charter.yml must exist in prosoc/prnc/charter",
        )

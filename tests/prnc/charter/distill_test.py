# Unit tests for prosoc.prnc.charter.distill
...
from prosoc.prnc.charter import distill
...
def schema_with_state():
    ...
    schema["properties"]["state"] = {
        ...
        # prosoc.nca.utils.cards.status.STATES) so the test schema stays aligned.
        "enum": [
            "DRAFTED",
            "EDITED",
            "AUDITED",

...
from prosoc.nca.auditor.orchestrator import audit_markdown_card
from prosoc.nca.auditor.orchestrator import audit_normative_card
from prosoc.nca.auditor.validator import validate_audit_report
...
class TestAuditMarkdownCard(unittest.TestCase):
    ...
    @mock.patch("prosoc.nca.literate.compiler.compile_markdown")

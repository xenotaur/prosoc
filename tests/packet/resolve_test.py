# Unit tests for prosoc.packet.resolve

import unittest

from prosoc.packet.errors import ResolveError
from prosoc.packet.manifest import Manifest, Member
from prosoc.packet.resolve import resolve
